class Bootloader extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.spritesheet("setting_button", "assets/setting_button.png",{ frameWidth: 236, frameHeight: 95 });
        this.load.spritesheet("credits_button", "assets/credits_button.png",{ frameWidth: 236, frameHeight: 95 });
        this.load.spritesheet("help_button", "assets/help_button.png",{ frameWidth: 236, frameHeight: 95 });
