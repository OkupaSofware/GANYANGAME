...
public class ChatRoomController {
	...
	@GetMapping("{chatRoomId}") //Get de mensajes //NO SE USA//
	...
	@GetMapping("{chatRoomId}/{userId}")  //Chequea conexión y obtiene información.
	...
	@DeleteMapping("{chatRoomId}/{userId}") //Update de estado del jugador a offline y eliminación del mismo de la lista de usuarios.
